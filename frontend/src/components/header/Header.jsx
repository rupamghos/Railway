...
import { faBed, faCalendarDays, faCar, faPerson, faPlane, faTaxi, faTicket, faTrain } from '@fortawesome/free-solid-svg-icons'
...
/>
      ...
      <div className="headerSearchItem">
      <button className="headerBtn" onClick={handleSearch}>Search Trains</button>
      </div>
    </div>
    </div></>}
    </div>
